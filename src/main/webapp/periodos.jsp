...
<head>
    <meta charset="UTF-8">
    <title>Administrar períodos</title>
...
<div class="container section">
    ...
    <div class="row">
        <div class="col s12 m5">
            <form method="post" action="${pageContext.request.contextPath}/periodos" class="card-panel z-depth-2">
        ...
        <div class="col s12 m7">
            <h5>Registros</h5>
            <div class="crud-filter" data-crud-filter="tabla-periodos">
                <div class="input-field">
                    <i class="material-icons prefix">search</i>
                    <input id="buscar-periodos" type="search" class="crud-filter-input" autocomplete="off" placeholder="Buscar por período, código o nombre">
                </div>
            ...
            <table id="tabla-periodos" class="striped highlight responsive-table">
        <thead>
        <tr>
            <c:forEach var="column" items="${columns}">
        ...
        <c:forEach var="row" items="${rows}">
            <tr data-record-row>
                ...
                <td>
                    <a class="btn-small orange" href="${pageContext.request.contextPath}/periodos?action=editar&id=${row[pkColumnName]}">Editar</a>
                    <form method="post" style="display:inline" action="${pageContext.request.contextPath}/periodos">
        ...
        <tfoot><tr><td class="crud-no-results" colspan="${columns.size() + 1}">No se encontraron períodos.</td></tr></tfoot>
    </table>
        </div>
    </div>
</div>
